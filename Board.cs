...
namespace 中国象棋
{
	public class Board : IReadOnlyCollection<Piece>
	{
		...
		static readonly Func<Piece, IntPoint, Board, IEnumerable<Move>> moves车 = (p, location, pieces) =>
		{
			...
			for (int x = location.X - 1; x >= 0; x--)
			{
				...
				{
					moves.Add(new Move(new IntPoint(x, location.Y), isProtecting: true));
					break;
				}
			}
			...
			for (int y = location.Y - 1; y >= 0; y--)
			{
				...
				{
					moves.Add(new Move(new IntPoint(location.X, y), isProtecting: true));
					break;
				}
			}
		...
		static readonly Func<Piece, IntPoint, Board, IEnumerable<Move>> moves马 = (p, location, pieces) =>
		{
			List<Move> moves = new List<Move>();
			if (location.X - 2 >= 0)
			{
				if (pieces[location.Y, location.X - 1] == null)
				{
					...
					if (location.Y - 1 >= 0)
						moves.Add(new Move(new IntPoint(location.X - 2, location.Y - 1), isProtecting: pieces[location.Y - 1, location.X - 2]?.Color == p.Color));
					if (location.Y + 1 <= 9)
						moves.Add(new Move(new IntPoint(location.X - 2, location.Y + 1), isProtecting: pieces[location.Y + 1, location.X - 2]?.Color == p.Color));
				}
			}
			...
			if (location.Y - 2 >= 0)
			{
				...
				{
					if (location.X - 1 >= 0)
						moves.Add(new Move(new IntPoint(location.X - 1, location.Y - 2), isProtecting: pieces[location.Y - 2, location.X - 1]?.Color == p.Color));
					if (location.X < 8)
						moves.Add(new Move(new IntPoint(location.X + 1, location.Y - 2), isProtecting: pieces[location.Y - 2, location.X + 1]?.Color == p.Color));
				}
			}
		...
		static readonly Func<Piece, IntPoint, Board, IEnumerable<Move>> moves象 = (p, location, pieces) =>
		{
			List<Move> moves = new List<Move>();
			if (location.Y - 2 >= 0 && location.X - 2 >= 0 && location.Y <= 4)
				moves.Add(new Move(new IntPoint(location.X - 2, location.Y - 2), isProtecting: pieces[location.Y - 2, location.X - 2]?.Color == p.Color));

			if (location.Y - 2 >= 0 && location.X + 2 < 9 && location.Y <= 4)
				moves.Add(new Move(new IntPoint(location.X + 2, location.Y - 2), isProtecting: pieces[location.Y - 2, location.X + 2]?.Color == p.Color));

			if (location.X - 2 >= 0 && location.Y <= 2)
				moves.Add(new Move(new IntPoint(location.X - 2, location.Y + 2), isProtecting: pieces[location.Y + 2, location.X - 2]?.Color == p.Color));

			if (location.X + 2 < 9 && location.Y <= 2)
				moves.Add(new Move(new IntPoint(location.X + 2, location.Y + 2), isProtecting: pieces[location.Y + 2, location.X + 2]?.Color == p.Color));


			if (location.X - 2 >= 0 && location.Y >= 7)
				moves.Add(new Move(new IntPoint(location.X - 2, location.Y - 2), isProtecting: pieces[location.Y - 2, location.X - 2]?.Color == p.Color));

			if (location.X + 2 < 9 && location.Y >= 7)
				moves.Add(new Move(new IntPoint(location.X + 2, location.Y - 2), isProtecting: pieces[location.Y - 2, location.X + 2]?.Color == p.Color));

			if (location.Y >= 5 && location.X - 2 >= 0 && location.Y + 2 <= 9)
				moves.Add(new Move(new IntPoint(location.X - 2, location.Y + 2), isProtecting: pieces[location.Y + 2, location.X - 2]?.Color == p.Color));

			if (location.Y >= 5 && location.X + 2 < 9 && location.Y + 2 <= 9)
				moves.Add(new Move(new IntPoint(location.X + 2, location.Y + 2), isProtecting: pieces[location.Y + 2, location.X + 2]?.Color == p.Color));

			return moves;
		};

		static readonly Func<Piece, IntPoint, Board, IEnumerable<Move>> moves士 = (p, location, pieces) =>
		{
			var moves = new List<Move>();
			if (location.X - 1 >= 0 && location.Y - 1 >= 0 && location.Y <= 2 && location.X >= 4)
				moves.Add(new Move(new IntPoint(location.X - 1, location.Y - 1), isProtecting: pieces[location.Y - 1, location.X - 1]?.Color == p.Color));

			if (location.X + 1 >= 0 && location.Y - 1 >= 0 && location.Y <= 2 && location.X <= 4)
				moves.Add(new Move(new IntPoint(location.X + 1, location.Y - 1), isProtecting: pieces[location.Y - 1, location.X + 1]?.Color == p.Color));

			if (location.X - 1 >= 0 && location.Y <= 1 && location.X >= 4)
				moves.Add(new Move(new IntPoint(location.X - 1, location.Y + 1), isProtecting: pieces[location.Y + 1, location.X - 1]?.Color == p.Color));
			...
			if (location.X - 1 >= 0 && location.Y >= 7 && location.X >= 4)
				moves.Add(new Move(new IntPoint(location.X - 1, location.Y - 1), isProtecting: pieces[location.Y - 1, location.X - 1]?.Color == p.Color));

			if (location.X + 1 >= 0 && location.Y >= 7 && location.X <= 4)
				moves.Add(new Move(new IntPoint(location.X + 1, location.Y - 1), isProtecting: pieces[location.Y - 1, location.X + 1]?.Color == p.Color));

			if (location.X - 1 >= 0 && location.Y + 1 <= 9 && location.Y >= 7 && location.X >= 4)
				moves.Add(new Move(new IntPoint(location.X - 1, location.Y + 1), isProtecting: pieces[location.Y + 1, location.X - 1]?.Color == p.Color));
		...
		static readonly Func<Piece, IntPoint, Board, IEnumerable<Move>> moves将 = (p, location, pieces) =>
		{
			var moves = new List<Move>();
			if (location.X >= 4)
				moves.Add(new Move(new IntPoint(location.X - 1, location.Y), isProtecting: pieces[location.Y, location.X - 1]?.Color == p.Color));

			if (location.X <= 4)
				moves.Add(new Move(new IntPoint(location.X + 1, location.Y), isProtecting: pieces[location.Y, location.X + 1]?.Color == p.Color));

			if (1 <= location.Y && location.Y <= 2)
				moves.Add(new Move(new IntPoint(location.X, location.Y - 1), isProtecting: pieces[location.Y - 1, location.X]?.Color == p.Color));
		...
		static readonly Func<Piece, IntPoint, Board, IEnumerable<Move>> moves炮 = (p, location, pieces) =>
		{
			var moves = new List<Move>();
			for (int x = location.X - 1; x >= 0; x--)
			{
				if (pieces[location.Y, x] == null)
					moves.Add(new Move(new IntPoint(x, location.Y), false));
				else
				{   //吃子
					for (int xx = x - 1; xx >= 0; xx--)
					{
						...
						{
							moves.Add(new Move(new IntPoint(xx, location.Y), isProtecting: pieces[location.Y, xx].Color == p.Color));
							break;
						}
					}
					break;
			...
			{
				if (pieces[y, location.X] == null)
					moves.Add(new Move(new IntPoint(location.X, y), false));
				else
				{
					for (int yy = y - 1; yy >= 0; yy--)
					{
						...
						{
							moves.Add(new Move(new IntPoint(location.X, yy), isProtecting: pieces[yy, location.X].Color == p.Color));
							break;
						}
					}
					break;
		...
		static readonly Func<Piece, IntPoint, Board, IEnumerable<Move>> moves兵 = (p, location, pieces) =>
		{
			var moves = new List<Move>();
		...
		public virtual Board Move(IntPoint location, IntPoint targetLocation, out Piece eatenPiece)
		{
			var newBoard = MoveCore(location, targetLocation, out eatenPiece);

			return new Board(newBoard);
		}

		protected Piece[,] MoveCore(IntPoint startLocation, IntPoint targetLocation, out Piece eatenPiece)
		{
			Debug.Assert(board[startLocation.Y, startLocation.X] != null, $"想要从({startLocation.X},{startLocation.Y})走子，但该位置没有棋子。");

			var newBoard = (Piece[,])board.Clone();
			eatenPiece = newBoard[targetLocation.Y, targetLocation.X];

			newBoard[targetLocation.Y, targetLocation.X] = newBoard[startLocation.Y, startLocation.X];
			newBoard[startLocation.Y, startLocation.X] = null;
			return newBoard;
		}
	...
	public struct Move
	{
		...
		public Move(IntPoint target, bool isEat = true, bool isProtecting = false)
		{
			Target = target;
			IsEat = isEat;
